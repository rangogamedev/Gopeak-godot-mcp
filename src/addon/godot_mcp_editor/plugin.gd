...
# Headless CI editor boots have no MCP server listening, so the client otherwise
# spins connect_failed/backoff churn for the whole run. Restrict to hooks/CI scripts.
